...
sudo ln -sf "$NVM_DIR/versions/node/$(nvm version)/bin/node" "/usr/bin/node" \
sudo ln -sf "$NVM_DIR/versions/node/$(nvm version)/bin/node" "/usr/local/bin/node" \
sudo ln -sf "$NVM_DIR/versions/node/$(nvm version)/bin/npm" "/usr/bin/npm" \
sudo ln -sf "$NVM_DIR/versions/node/$(nvm version)/bin/npm" "/usr/local/bin/npm" \
sudo ln -sf "$NVM_DIR/versions/node/$(nvm version)/bin/pm2" "/usr/bin/pm2" \
